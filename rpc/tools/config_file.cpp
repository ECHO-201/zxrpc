...
std::string config_file::GetStringInfo(const std::string& section, const std::string& key, const std::string& default_value)
{
...
float config_file::GetFloatInfo(const std::string& section, const std::string& key, const float& default_value)
{
...
std::vector<std::string> config_file::GetStringListInfo(const std::string& section, const std::string& key)
{
    std::vector<std::string> v;
    std::string str = GetStringInfo(section, key, "");
    std::string sep = ", \t";
    std::string substr;
...
unsigned config_file::GetNumberInfo(const std::string& section, const std::string& key, unsigned default_value)
{
    STR_MAP_ITER it = _map.find(section);
    if (it != _map.end())
    {
...
bool config_file::GetBoolInfo(const std::string& section, const std::string& key, bool default_value)
{
    STR_MAP_ITER it = _map.find(section);
    if (it != _map.end())
    {
